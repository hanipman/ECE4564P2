...
def callback(ch, method, properties, body):
    ...
    if str(body) == 'b\'purple\'':
        print("[Checkpoint 1-01] Flashing LED purple")
    elif str(body) == 'b\'yellow\'':
        print("[Checkpoint 1-01] Flashing LED yellow")
    elif str(body) == 'b\'blue\'':
        print("[Checkpoint 1-01] Flashing LED blue")
    elif str(body) == 'b\'green\'':
